...
public class StubAuthLoginService implements IFHauthLoginService {
	...
	private List<User> getStubUsers() {
		...
		users.add(new User(1L, "Dennis", "Richie", "", "admin"));
		...
		users.add(new User(6L, "James", "Gosling", "1STG", "eleve"));
		users.add(new User(7L, "Bertrand", "Meyer", "1ES", "eleve"));
		users.add(new User(8L, "Niklaus", "Wirth", "1ES", "eleve"));
